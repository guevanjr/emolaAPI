...
class Operation extends WSDLElement {
  constructor(nsName, attrs, options) {
    super(nsName, attrs, options); //there can be multiple faults defined in the operation. They all will have same type name 'fault'
  ...
  addChild(child) {
    switch (child.name) {
      ...
      case 'operation':
        ...
        this.soapActionRequired = child.$soapActionRequired === 'true' || child.$soapActionRequired === '1' || false; //figure out from the binding operation soap version 1.1 or 1.2
  ...
  static createEnvelopeDescriptor(parameterDescriptor, isOutput, soapVersion, prefix, nsURI) {
    ...
    envelopeDescriptor.addElement(bodyDescriptor); //add only if input or output. Fault is list of faults unlike input/output element and fault needs further processing below,
